...
$lobjPdf->SetFont("arial","",8);
$lobjPdf->Cell(145,6,utf8_decode($laFactura['direccioncli']),0,0,"L");
$lobjPdf->Cell(40,6,utf8_decode($laFactura['fechafac']),"L",1,"C");
...
$lobjPdf->Cell(10,6,utf8_decode("Nombre: "),0,0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(40,6,utf8_decode($laFactura['nombrecho'].' '.$laFactura['apellidocho']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);

$lobjPdf->Cell(10,6,utf8_decode("Placa: "),"L",0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(10,6,utf8_decode($laFactura['placaveh']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);
$lobjPdf->Cell(20,6,utf8_decode("Color: "),0,0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(35,6,utf8_decode($laFactura['colorveh']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);

$lobjPdf->Cell(15,6,utf8_decode("Placa: "),"L",0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(15,6,utf8_decode($laFactura['placaacc']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);
...
$lobjPdf->SetFont("arial","B",6);
$lobjPdf->Cell(10,6,utf8_decode("C.I. : "),0,0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(40,6,utf8_decode($laFactura['nacionalidadcho'].'-'.$laFactura['cedula_rifcho']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);

$lobjPdf->Cell(10,6,utf8_decode("Año: "),"L",0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(10,6,utf8_decode($laFactura['anoveh']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);
$lobjPdf->Cell(20,6,utf8_decode("Marca: "),0,0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(35,6,utf8_decode($laFactura['marcaveh']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);
...
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(15,6,utf8_decode($laFactura['anoacc']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);
...
$lobjPdf->SetX(60);
$lobjPdf->SetFont("arial","B",6);
$lobjPdf->Cell(10,6,utf8_decode("Modelo: "),"L",0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(65,6,utf8_decode($laFactura['modeloveh']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);


$lobjPdf->Cell(15,6,utf8_decode("Capacidad: "),"L",0,"L");
$lobjPdf->SetFont("arial","",6);
$lobjPdf->Cell(15,6,utf8_decode($laFactura['capacidadacc'].' '.$laFactura['unidadmedidaacc']),0,0,"L");
$lobjPdf->SetFont("arial","B",6);
...
for($i=0;$i<count($laFactura_Productos);$i++)
{
	...
	$lobjPdf->Cell(40,6,utf8_decode($laFactura_Productos[$i]['cantidadpro'].' '.$laFactura_Productos[$i]['unidadmedidapro']),1,0,"C");
	$lobjPdf->Cell(80,6,utf8_decode($laFactura_Productos[$i]['descripcioncortapro']),1,0,"C");
	$lobjPdf->Cell(40,6,utf8_decode($laFactura_Productos[$i]['preciopro']),1,0,"C");
...
$lobjPdf->Cell(40,6,utf8_decode($laFactura['totalfac']-$laFactura['ivafac']),1,1,"C");

$lobjPdf->SetX(130);
$lobjPdf->SetFont("arial","B",8);
$lobjPdf->Cell(40,6,utf8_decode("IVA: "),1,0,"R",true);
$lobjPdf->SetFont("arial","",10);
$lobjPdf->Cell(40,6,utf8_decode($laFactura['ivafac']),1,1,"C");
$lobjPdf->SetFont("arial","B",8);

$lobjPdf->SetX(130);
$lobjPdf->Cell(40,6,utf8_decode("TOTAL: "),1,0,"R",true);
$lobjPdf->SetFont("arial","",10);
$lobjPdf->Cell(40,6,utf8_decode($laFactura['totalfac']),1,1,"C");
